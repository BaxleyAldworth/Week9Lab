...
namespace Week9Lab
{
    ...
    public class ApplicationUserManager : UserManager<TwitterUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<TwitterUser>(context.Get<ApplicationDbContext>()));
            ...
            manager.RegisterTwoFactorProvider("Phone Code", new PhoneNumberTokenProvider<TwitterUser>
            {
                MessageFormat = "Your security code is {0}"
            });
            manager.RegisterTwoFactorProvider("Email Code", new EmailTokenProvider<TwitterUser>
            {
